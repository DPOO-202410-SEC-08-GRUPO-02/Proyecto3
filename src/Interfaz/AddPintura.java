...
public class AddPintura extends JFrame implements ActionListener
{
	...
	private JLabel lblTituloMovimiento;
...
//		Panel central
        ...
        lblTituloMovimiento= new JLabel("Movimiento artistico:" );
        panelCentral.add(lblTituloMovimiento);
        txtMovimiento = new JTextField();
        panelCentral.add(txtMovimiento);
	...
	public void actionPerformed( ActionEvent e )
    {
		if(e.getActionCommand( ).equals("add"))
        {
			...
			movimiento = txtMovimiento.getText().trim();
			
			Pintura nuevaPieza = new Pintura(id, tecnica, autor, titulo, anio, lugar, estado, 
			disponibilidad, fechaLim,valor, consignacion, devolucion, subasta, valorM, valorI,tipo,
			alto, ancho, movimiento, instalacion, vendida, precio, fecha, duenios);	
